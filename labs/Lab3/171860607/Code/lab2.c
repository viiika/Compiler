    ...
    case e_Exp:
        {
            ...
            case e_DIV:
                ...
                #endif
                Type t1 = Exp(exp->child,opt1);
                Type t2 = Exp(exp->child->brother->brother,opt2);
                if (t1 == NULL || t2 == NULL)
                {
                    return NULL;
                }
            ...
            case e_ASSIGNOP: //a=b must be true
                {
                Operand opt1=(Operand)malloc(sizeof(struct Operand_));
                opt1->kind=OP_TMP_VARIABLE;
                opt1->u.var_no=tmp_var_no;
                ...
                #endif
                //in fact the follow is true so there is no need to write it
